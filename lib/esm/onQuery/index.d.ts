...
import type { DocOptions, OperationOptions, Query, RealtimeOptions, RuntimeEnvironment, ServerTimestampsStrategy } from '../types';
export declare type OnQueryOptions<Environment extends RuntimeEnvironment | undefined, ServerTimestamps extends ServerTimestampsStrategy> = DocOptions<ServerTimestamps> & OperationOptions<Environment> & RealtimeOptions;
 ...
 */
export declare function onQuery<Model, Environment extends RuntimeEnvironment | undefined, ServerTimestamps extends ServerTimestampsStrategy>(collection: Collection<Model> | CollectionGroup<Model>, queries: Query<Model, keyof Model>[], onResult: OnResult<Model, Environment, ServerTimestamps>, onError?: OnError, options?: OnQueryOptions<Environment, ServerTimestamps>): () => void;
export {};
