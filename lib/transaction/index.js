 ...
 */
function transaction(readFunction, writeFunction, options) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return a.firestore.runTransaction((t) => {
      function set(collectionOrRef, idOrData, maybeData) {
        ...
        t.set(firestoreDoc, (0, data_1.unwrapData)(a, data))
      }
      function upset(collectionOrRef, idOrData, maybeData) {
        ...
        // ^ above
        // TODO: Refactor code above and below because is all the same as in the regular set function
        t.set(firestoreDoc, (0, data_1.unwrapData)(a, data), { merge: true })
      }
      function update(collectionOrRef, idOrData, maybeData) {
        ...
        t.update(firebaseDoc, (0, data_1.unwrapData)(a, updateData))
      }
      ...
      return readFunction({
        get: (...props) =>
          __1.getCommon(props[0], props[1], props[2], { a, t }),
        query: (...props) =>
          (0, __1.queryCommon)(props[0], props[1], props[2], { a, t })
