 ...
 */
export declare type Doc<Model> = AnyDoc<
  Model,
  RuntimeEnvironment,
  boolean,
  ServerTimestampsStrategy
>
export declare type AnyDoc<
  Model,
...
export declare type ModelData<Model> =
  | AnyModelData<Model, true>
  | AnyModelData<Model, false>
...
> = Field extends ServerDate
  ...
  : Field
export declare type ResolvedServerDate<
  Environment extends RuntimeEnvironment | undefined,
  FromCache extends boolean,
  ServerTimestamps extends ServerTimestampsStrategy
> = Environment extends 'node'
...
export declare type ResolvedWebServerDate<
  FromCache extends boolean,
  ServerTimestamps extends ServerTimestampsStrategy
> = FromCache extends false | undefined
  ? Date
  : ServerTimestamps extends 'estimate'
  ? Date
  : Date | null
