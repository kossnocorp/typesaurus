...
declare type MaybeValueRemoveOr<
  Model,
...
> = Partial<Pick<Model, Key>> extends Pick<Model, Key>
  ...
  : ValueType
declare type MaybeValueRemove<Model, Key extends keyof Model> = Partial<
  Pick<Model, Key>
 ...
 */
export declare type SetValue<Type> = Type extends ServerDate
  ? ValueServerDate
  : never
/**
